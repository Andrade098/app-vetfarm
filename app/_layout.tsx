// app/_layout.tsx - ARQUIVO COMPLETO ATUALIZADO
...
import { CartProvider } from '../contexts/CartContext'; // ⭐⭐ IMPORTE O CART PROVIDER

export default function RootLayout() {
  return (
    <AuthProvider>
      <CartProvider> {/* ⭐⭐ ADICIONE O CART PROVIDER AQUI */}
        <EnderecoProvider>
          <PedidoProvider>
      ...
      </CartProvider> {/* ⭐⭐ FECHE O CART PROVIDER */}
    </AuthProvider>
  );
}